...
public class JwtTokenHandler {
    ...
    public String createToken(String username, String role, long id, String fullName) {
        Date now = new Date();
        ...
        JwtBuilder builder = Jwts.builder().setIssuedAt(now).setSubject(username).claim("rol", role).claim("id", id).claim("fnm", fullName)
